import{t as e}from"./shaderStore-Cl2MRAbk.js";import"./ltcHelperFunctions-hDkO7S83.js";import"./mainUVVaryingDeclaration-5e-Yhx7D.js";var t=`pbrFragmentExtraDeclaration`,n=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
{return diffusionProfile<1.;}`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=a);var o={name:i,shader:a},s=`pbrHelperFunctions`,c=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=c);var l={name:s,shader:c},u=`pbrDirectLightingSetupFunctions`,d=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=d);var f={name:u,shader:d},p=`pbrDirectLightingFalloffFunctions`,m=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=m);var h={name:p,shader:m},g=`pbrDirectLightingFunctions`,_=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=_);var v={name:g,shader:_},y=`pbrBlockNormalGeometric`,b=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=b);var x={name:y,shader:b},S=`pbrBlockImageProcessing`,C=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=C);var w={name:S,shader:C},T=`pbrDebug`,E=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=E);var D={name:T,shader:E};export{h as a,o as c,v as i,r as l,w as n,f as o,x as r,l as s,D as t};