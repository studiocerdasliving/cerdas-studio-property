import{t as e}from"./shaderStore-Cl2MRAbk.js";import"./ltcHelperFunctions-EAX2-n3v.js";import"./clusteredLightingFunctions-CnbOVSo5.js";import"./mainUVVaryingDeclaration-VCNLG_TF.js";var t=`pbrFragmentExtraDeclaration`,n=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
{return diffusionProfile<1.;}`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=a);var o={name:i,shader:a},s=`pbrHelperFunctions`,c=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=c);var l={name:s,shader:c},u=`pbrDirectLightingSetupFunctions`,d=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=d);var f={name:u,shader:d},p=`pbrDirectLightingFalloffFunctions`,m=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=m);var h={name:p,shader:m},g=`pbrBlockReflectance0`,_=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
