...
`;t.ShadersStore[w]||(t.ShadersStore[w]=T);var E=[n,r,a,o,m,y,p,S,d,f,s,c,h,l,i,u,g];for(let e of E)t.IncludesShadersStore[e.name]||(t.IncludesShadersStore[e.name]=e.shader);var D={name:w,shader:T};export{C as n,D as t};