import{t as e}from"./rolldown-runtime-WNZMJCWm.js";import{t}from"./shaderStore-Cl2MRAbk.js";var n=e({vrDistortionCorrectionPixelShaderWGSL:()=>a}),r=`vrDistortionCorrectionPixelShader`,i=`#define DISABLE_UNIFORMITY_ANALYSIS
...
else{fragmentOutputs.color=textureSample(textureSampler,textureSamplerSampler,tc);}}`;t.ShadersStoreWGSL[r]||(t.ShadersStoreWGSL[r]=i);var a={name:r,shader:i};export{n,a as t};