import{t as e}from"./rolldown-runtime-WNZMJCWm.js";import{t}from"./shaderStore-Cl2MRAbk.js";import{t as n}from"./samplerFragmentDeclaration-DHmS82tX.js";import{t as r}from"./clipPlaneFragment-CH3aZCXN.js";import{t as i}from"./clipPlaneFragmentDeclaration-BmZ_mboQ.js";import{t as a}from"./fogFragmentDeclaration-BNau0c59.js";import{t as o}from"./logDepthFragment-GhoqkMiq.js";import{t as ee}from"./fogFragment-D68TYqPH.js";import{t as te}from"./harmonicsFunctions-38t5XK64.js";import{t as ne}from"./helperFunctions-XZzpehR-.js";import{t as re}from"./imageProcessingDeclaration-BZzRO3oR.js";import{t as ie}from"./imageProcessingFunctions-BbLUD4uP.js";import{t as ae}from"./lightFragmentDeclaration-rwHevrvA.js";import{t as oe}from"./lightUboDeclaration-r-Br3WN-.js";import{t as se}from"./ltcHelperFunctions-hDkO7S83.js";import{t as ce}from"./logDepthDeclaration-CqDOU_5b.js";import{t as le}from"./reflectionFunction-DCyNMx5x.js";import{t as ue}from"./shadowsFragmentFunctions-Db7J61Pw.js";import{t as de}from"./sceneUboDeclaration-CwKQCQSn.js";import{a as fe,i as pe,n as me,o as he,r as ge,t as _e}from"./oitFragment-CAN0_1x4.js";import{t as ve}from"./meshUboDeclaration-CXAB_v_o.js";import{t as ye}from"./mainUVVaryingDeclaration-5e-Yhx7D.js";import{n as be,t as xe}from"./pbrIBLFunctions-D8YeMxiL.js";import{t as Se}from"./sceneFragmentDeclaration-aLnr6NPX.js";import{t as Ce}from"./pbrBRDFFunctions-l_QRoo__.js";import{a as we,i as Te,n as Ee,r as De,t as Oe}from"./openpbrTransmissionLayerData-DTbF90kP.js";import{n as ke,t as Ae}from"./hdrFilteringFunctions-BQs5cPNy.js";import{t as je}from"./openpbrUboDeclaration-BMTOc2Hj.js";import{a as Me,c as Ne,i as Pe,l as Fe,n as Ie,o as Le,r as s,s as c,t as l}from"./pbrDebug-DCYZJpVQ.js";var u=`openpbrFragmentDeclaration`,d=`uniform float vBaseWeight;uniform vec4 vBaseColor;uniform float vBaseDiffuseRoughness;uniform vec4 vReflectanceInfo;uniform vec4 vSpecularColor;uniform vec3 vSpecularAnisotropy;uniform float vTransmissionWeight;uniform vec3 vTransmissionColor;uniform float vTransmissionDepth;uniform vec3 vTransmissionScatter;uniform float vTransmissionScatterAnisotropy;uniform float vTransmissionDispersionScale;uniform float vTransmissionDispersionAbbeNumber;uniform float vSubsurfaceWeight;uniform vec3 vSubsurfaceColor;uniform float vSubsurfaceRadius;uniform vec3 vSubsurfaceRadiusScale;uniform float vSubsurfaceScatterAnisotropy;uniform float vCoatWeight;uniform vec3 vCoatColor;uniform float vCoatRoughness;uniform float vCoatRoughnessAnisotropy;uniform float vCoatIor;uniform float vCoatDarkening;uniform float vFuzzWeight;uniform vec3 vFuzzColor;uniform float vFuzzRoughness;uniform vec2 vGeometryCoatTangent;uniform float vGeometryThickness;uniform vec3 vEmissionColor;uniform float vThinFilmWeight;uniform vec2 vThinFilmThickness;uniform float vThinFilmIor;uniform float vGeometryThinWalled;uniform vec4 vLightingIntensity;uniform float visibility;uniform vec2 renderTargetSize;
#ifdef BASE_COLOR
...
`;t.IncludesShadersStore[u]||(t.IncludesShadersStore[u]=d);var f={name:u,shader:d},p=`openpbrFragmentSamplersDeclaration`,m=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;t.IncludesShadersStore[p]||(t.IncludesShadersStore[p]=m);var h={name:p,shader:m},g=`openpbrNormalMapFragmentMainFunctions`,_=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;t.IncludesShadersStore[g]||(t.IncludesShadersStore[g]=_);var Re={name:g,shader:_},v=`openpbrNormalMapFragmentFunctions`,y=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;t.IncludesShadersStore[v]||(t.IncludesShadersStore[v]=y);var b={name:v,shader:y},x=`openpbrConductorReflectance`,S=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;t.IncludesShadersStore[x]||(t.IncludesShadersStore[x]=S);var ze={name:x,shader:S},C=`openpbrAmbientOcclusionFunctions`,w=`float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
`;t.IncludesShadersStore[C]||(t.IncludesShadersStore[C]=w);var Be={name:C,shader:w},T=`openpbrVolumeFunctions`,E=`struct OpenPBRHomogeneousVolume {vec3 extinction_coeff; 
vec3 ss_albedo; 
...
weight_sum.b<1e-5f ? unconvolved_irradiance.b : irradiance_sum.b/weight_sum.b);}`;t.IncludesShadersStore[T]||(t.IncludesShadersStore[T]=E);var Ve={name:T,shader:E},D=`openpbrNormalMapFragment`,O=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;t.IncludesShadersStore[D]||(t.IncludesShadersStore[D]=O);var He={name:D,shader:O},k=`openpbrBlockNormalFinal`,A=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;t.IncludesShadersStore[k]||(t.IncludesShadersStore[k]=A);var Ue={name:k,shader:A},j=`openpbrBaseLayerData`,M=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;t.IncludesShadersStore[j]||(t.IncludesShadersStore[j]=M);var We={name:j,shader:M},N=`openpbrCoatLayerData`,P=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;t.IncludesShadersStore[N]||(t.IncludesShadersStore[N]=P);var Ge={name:N,shader:P},F=`openpbrThinFilmLayerData`,I=`#ifdef THIN_FILM
...
#endif
`;t.IncludesShadersStore[F]||(t.IncludesShadersStore[F]=I);var Ke={name:F,shader:I},L=`openpbrFuzzLayerData`,R=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;t.IncludesShadersStore[L]||(t.IncludesShadersStore[L]=R);var qe={name:L,shader:R},z=`openpbrAmbientOcclusionData`,B=`vec3 ambient_occlusion=vec3(1.0);float specular_ambient_occlusion=1.0;float coat_specular_ambient_occlusion=1.0;
#ifdef AMBIENT_OCCLUSION
...
#endif
`;t.IncludesShadersStore[z]||(t.IncludesShadersStore[z]=B);var Je={name:z,shader:B},V=`openpbrBackgroundTransmission`,H=`vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;t.IncludesShadersStore[V]||(t.IncludesShadersStore[V]=H);var Ye={name:V,shader:H},U=`openpbrEnvironmentLighting`,W=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;t.IncludesShadersStore[U]||(t.IncludesShadersStore[U]=W);var Xe={name:U,shader:W},G=`openpbrDirectLightingInit`,K=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.IncludesShadersStore[G]||(t.IncludesShadersStore[G]=K);var Ze={name:G,shader:K},q=`openpbrDirectLighting`,J=`#ifdef LIGHT{X}
...
#endif
`;t.IncludesShadersStore[q]||(t.IncludesShadersStore[q]=J);var Qe={name:q,shader:J},Y=`openpbrBlockPrePass`,X=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;t.IncludesShadersStore[Y]||(t.IncludesShadersStore[Y]=X);var $e={name:Y,shader:X},et=e({openpbrPixelShader:()=>$}),Z=`openpbrPixelShader`,Q=`#define OPENPBR_FRAGMENT_SHADER
...
`;t.ShadersStore[Z]||(t.ShadersStore[Z]=Q);var tt=[fe,pe,Se,he,f,de,ve,je,ye,Fe,ae,oe,n,be,h,re,i,ce,a,ge,ne,Ne,ke,c,ie,ue,te,se,Le,Me,Ce,Ae,Pe,xe,Re,b,le,we,ze,Be,Te,De,Ve,r,s,He,Ue,We,Oe,Ee,Ge,Ke,qe,Je,me,Ye,Xe,Ze,Qe,o,ee,Ie,$e,_e,l];for(let e of tt)t.IncludesShadersStore[e.name]||(t.IncludesShadersStore[e.name]=e.shader);var $={name:Z,shader:Q};export{et as n,$ as t};