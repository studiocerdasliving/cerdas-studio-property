import{t as e}from"./shaderStore-Cl2MRAbk.js";var t=`noisePixelShader`,n=`uniform float brightness;uniform float persistence;uniform float timeScale;varying vec2 vUV;vec2 hash22(vec2 p)
...
`;e.ShadersStore[t]||(e.ShadersStore[t]=n);var r={name:t,shader:n};export{r as noisePixelShader};