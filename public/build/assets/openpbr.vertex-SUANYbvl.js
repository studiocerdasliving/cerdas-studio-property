...
}`;t.ShadersStoreWGSL[U]||(t.ShadersStoreWGSL[U]=W);var G=[h,w,F,j,T,s,P,n,g,_,k,E,o,R,a,v,c,p,d,l,N,D,f,u,y,r,b,A,O,M,V,i,x,m,C,S];for(let e of G)t.IncludesShadersStoreWGSL[e.name]||(t.IncludesShadersStoreWGSL[e.name]=e.shader);var K={name:U,shader:W};export{H as n,K as t};