import{t as e}from"./rolldown-runtime-WNZMJCWm.js";import{t}from"./shaderStore-Cl2MRAbk.js";import{t as ee}from"./samplerFragmentDeclaration-CKcoTC7g.js";import{t as te}from"./clipPlaneFragment-B5ejIpVP.js";import{t as ne}from"./clipPlaneFragmentDeclaration-BxvG-V2U.js";import{t as n}from"./fogFragmentDeclaration-Bc2fDDwH.js";import{t as r}from"./logDepthFragment-C81THFK4.js";import{t as i}from"./fogFragment-E2nd7wnn.js";import{t as a}from"./harmonicsFunctions-wL5E3BED.js";import{t as o}from"./helperFunctions-Djh0sij1.js";import{t as s}from"./imageProcessingDeclaration-D9xTQOxH.js";import{t as re}from"./imageProcessingFunctions-BzShnS-E.js";import{t as ie}from"./lightUboDeclaration-Cte6c5rj.js";import{t as ae}from"./ltcHelperFunctions-EAX2-n3v.js";import{t as oe}from"./clusteredLightingFunctions-CnbOVSo5.js";import{t as se}from"./logDepthDeclaration-D7WB_x2I.js";import{t as ce}from"./reflectionFunction-WTBpVMs8.js";import{t as le}from"./shadowsFragmentFunctions-CDP9ih3X.js";import{t as ue}from"./sceneUboDeclaration-B6mDFmkL.js";import{t as de}from"./meshUboDeclaration-ooIKMxUe.js";import{a as fe,i as pe,n as me,r as he,t as ge}from"./oitFragment-BFLLO9Kf.js";import{t as _e}from"./mainUVVaryingDeclaration-VCNLG_TF.js";import{n as ve,t as ye}from"./pbrIBLFunctions-BYdvNQ2G.js";import{t as be}from"./pbrBRDFFunctions-C-wkVMnm.js";import{a as xe,i as Se,n as Ce,r as we,t as Te}from"./openpbrTransmissionLayerData-D3AlxLCM.js";import{n as Ee,t as De}from"./hdrFilteringFunctions-DjZDY-fd.js";import{t as Oe}from"./openpbrUboDeclaration-BM-SmCBV.js";import{a as ke,c as Ae,i as je,l as Me,n as Ne,o as Pe,r as c,s as l,t as u,u as d}from"./pbrDebug-BrYMm-Tv.js";var f=`openpbrFragmentSamplersDeclaration`,p=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;t.IncludesShadersStoreWGSL[f]||(t.IncludesShadersStoreWGSL[f]=p);var m={name:f,shader:p},h=`openpbrNormalMapFragmentMainFunctions`,g=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;t.IncludesShadersStoreWGSL[h]||(t.IncludesShadersStoreWGSL[h]=g);var _={name:h,shader:g},v=`openpbrNormalMapFragmentFunctions`,y=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;t.IncludesShadersStoreWGSL[v]||(t.IncludesShadersStoreWGSL[v]=y);var Fe={name:v,shader:y},b=`openpbrConductorReflectance`,x=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;t.IncludesShadersStoreWGSL[b]||(t.IncludesShadersStoreWGSL[b]=x);var S={name:b,shader:x},C=`openpbrAmbientOcclusionFunctions`,w=`fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
`;t.IncludesShadersStoreWGSL[C]||(t.IncludesShadersStoreWGSL[C]=w);var Ie={name:C,shader:w},T=`openpbrVolumeFunctions`,E=`struct OpenPBRHomogeneousVolume {extinction_coeff: vec3f, 
ss_albedo: vec3f, 
...
`;t.IncludesShadersStoreWGSL[T]||(t.IncludesShadersStoreWGSL[T]=E);var Le={name:T,shader:E},D=`openpbrNormalMapFragment`,O=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;t.IncludesShadersStoreWGSL[D]||(t.IncludesShadersStoreWGSL[D]=O);var Re={name:D,shader:O},k=`openpbrBlockNormalFinal`,A=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[k]||(t.IncludesShadersStoreWGSL[k]=A);var ze={name:k,shader:A},j=`openpbrBaseLayerData`,M=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);var geometry_thickness: f32=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;t.IncludesShadersStoreWGSL[j]||(t.IncludesShadersStoreWGSL[j]=M);var Be={name:j,shader:M},N=`openpbrCoatLayerData`,P=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;t.IncludesShadersStoreWGSL[N]||(t.IncludesShadersStoreWGSL[N]=P);var Ve={name:N,shader:P},F=`openpbrThinFilmLayerData`,I=`#ifdef THIN_FILM
...
#endif
`;t.IncludesShadersStoreWGSL[F]||(t.IncludesShadersStoreWGSL[F]=I);var He={name:F,shader:I},L=`openpbrFuzzLayerData`,R=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[L]||(t.IncludesShadersStoreWGSL[L]=R);var Ue={name:L,shader:R},z=`openpbrAmbientOcclusionData`,B=`var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
#endif
`;t.IncludesShadersStoreWGSL[z]||(t.IncludesShadersStoreWGSL[z]=B);var We={name:z,shader:B},V=`openpbrBackgroundTransmission`,H=`var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;t.IncludesShadersStoreWGSL[V]||(t.IncludesShadersStoreWGSL[V]=H);var Ge={name:V,shader:H},U=`openpbrEnvironmentLighting`,W=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;t.IncludesShadersStoreWGSL[U]||(t.IncludesShadersStoreWGSL[U]=W);var Ke={name:U,shader:W},G=`openpbrDirectLightingInit`,K=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[G]||(t.IncludesShadersStoreWGSL[G]=K);var qe={name:G,shader:K},q=`openpbrDirectLighting`,J=`#ifdef LIGHT{X}
...
#endif
`;t.IncludesShadersStoreWGSL[q]||(t.IncludesShadersStoreWGSL[q]=J);var Je={name:q,shader:J},Y=`openpbrBlockPrePass`,X=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[Y]||(t.IncludesShadersStoreWGSL[Y]=X);var Ye={name:Y,shader:X},Xe=e({openpbrPixelShaderWGSL:()=>$}),Z=`openpbrPixelShader`,Q=`#define OPENPBR_FRAGMENT_SHADER
...
`;t.ShadersStoreWGSL[Z]||(t.ShadersStoreWGSL[Z]=Q);var Ze=[fe,pe,ue,de,Oe,_e,d,ie,ee,ve,m,s,ne,se,n,he,o,Me,Ee,Ae,re,le,a,ae,l,Pe,be,De,oe,ke,je,ye,_,Fe,ce,xe,S,Ie,Se,we,Le,te,c,Re,ze,Be,Te,Ce,Ve,He,Ue,We,me,Ge,Ke,qe,Je,r,i,Ne,Ye,ge,u];for(let e of Ze)t.IncludesShadersStoreWGSL[e.name]||(t.IncludesShadersStoreWGSL[e.name]=e.shader);var $={name:Z,shader:Q};export{Xe as n,$ as t};