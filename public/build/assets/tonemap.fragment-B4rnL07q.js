import{t as e}from"./rolldown-runtime-WNZMJCWm.js";import{t}from"./shaderStore-Cl2MRAbk.js";var n=e({tonemapPixelShader:()=>a}),r=`tonemapPixelShader`,i=`varying vec2 vUV;uniform sampler2D textureSampler;uniform float _ExposureAdjustment;
...
#endif
gl_FragColor=vec4(colour.rgb,1.0);}`;t.ShadersStore[r]||(t.ShadersStore[r]=i);var a={name:r,shader:i};export{n,a as t};