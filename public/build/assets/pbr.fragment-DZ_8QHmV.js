import{t as e}from"./rolldown-runtime-WNZMJCWm.js";import{t}from"./shaderStore-Cl2MRAbk.js";import{t as ee}from"./bumpFragment-oCMBoLdm.js";import{t as te}from"./samplerFragmentDeclaration-DHmS82tX.js";import{t as ne}from"./bumpFragmentFunctions-2oTq5Vva.js";import{t as re}from"./bumpFragmentMainFunctions-DucibZA2.js";import{t as ie}from"./clipPlaneFragment-CH3aZCXN.js";import{t as ae}from"./clipPlaneFragmentDeclaration-BmZ_mboQ.js";import{t as oe}from"./fogFragmentDeclaration-BNau0c59.js";import{t as se}from"./logDepthFragment-GhoqkMiq.js";import{t as ce}from"./fogFragment-D68TYqPH.js";import{t as le}from"./harmonicsFunctions-38t5XK64.js";import{t as ue}from"./helperFunctions-XZzpehR-.js";import{t as de}from"./imageProcessingDeclaration-BZzRO3oR.js";import{t as fe}from"./imageProcessingFunctions-BbLUD4uP.js";import{t as pe}from"./lightFragment-CM5wNziA.js";import{t as me}from"./lightFragmentDeclaration-rwHevrvA.js";import{t as he}from"./lightUboDeclaration-r-Br3WN-.js";import{t as ge}from"./ltcHelperFunctions-hDkO7S83.js";import{t as _e}from"./clusteredLightingFunctions-CbtdvAmr.js";import{t as ve}from"./logDepthDeclaration-CqDOU_5b.js";import{t as ye}from"./reflectionFunction-DCyNMx5x.js";import{t as be}from"./shadowsFragmentFunctions-Db7J61Pw.js";import{t as xe}from"./sceneUboDeclaration-CwKQCQSn.js";import{a as Se,i as Ce,n as we,o as Te,r as Ee,t as De}from"./oitFragment-CAN0_1x4.js";import{t as Oe}from"./meshUboDeclaration-CXAB_v_o.js";import{t as ke}from"./mainUVVaryingDeclaration-5e-Yhx7D.js";import{t as Ae}from"./decalFragment-DgrtvLU1.js";import{n as je,t as Me}from"./pbrIBLFunctions-D8YeMxiL.js";import{t as Ne}from"./pbrBRDFFunctions-l_QRoo__.js";import{n as Pe,t as Fe}from"./hdrFilteringFunctions-BQs5cPNy.js";import{a as Ie,c as Le,i as Re,l as ze,n as Be,o as Ve,r as He,s as Ue,t as We}from"./pbrDebug-DCYZJpVQ.js";import{t as Ge}from"./pbrUboDeclaration-xwAif0oP.js";var n=`pbrFragmentDeclaration`,r=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;t.IncludesShadersStore[n]||(t.IncludesShadersStore[n]=r);var Ke={name:n,shader:r},i=`samplerFragmentAlternateDeclaration`,a=`#ifdef _DEFINENAME_
...
#endif
#endif
`;t.IncludesShadersStore[i]||(t.IncludesShadersStore[i]=a);var qe={name:i,shader:a},o=`pbrFragmentSamplersDeclaration`,s=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;t.IncludesShadersStore[o]||(t.IncludesShadersStore[o]=s);var Je={name:o,shader:s},c=`pbrBlockAlbedoOpacity`,l=`struct albedoOpacityOutParams
...
`;t.IncludesShadersStore[c]||(t.IncludesShadersStore[c]=l);var Ye={name:c,shader:l},u=`pbrBlockReflectivity`,d=`struct reflectivityOutParams
...
`;t.IncludesShadersStore[u]||(t.IncludesShadersStore[u]=d);var Xe={name:u,shader:d},f=`pbrBlockAmbientOcclusion`,p=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;t.IncludesShadersStore[f]||(t.IncludesShadersStore[f]=p);var Ze={name:f,shader:p},m=`pbrBlockAlphaFresnel`,h=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;t.IncludesShadersStore[m]||(t.IncludesShadersStore[m]=h);var Qe={name:m,shader:h},g=`pbrBlockAnisotropic`,_=`#ifdef ANISOTROPIC
...
#endif
`;t.IncludesShadersStore[g]||(t.IncludesShadersStore[g]=_);var $e={name:g,shader:_},v=`pbrBlockReflection`,y=`#ifdef REFLECTION
...
#endif
`;t.IncludesShadersStore[v]||(t.IncludesShadersStore[v]=y);var et={name:v,shader:y},b=`pbrBlockSheen`,x=`#ifdef SHEEN
...
#endif
`;t.IncludesShadersStore[b]||(t.IncludesShadersStore[b]=x);var tt={name:b,shader:x},S=`pbrBlockClearcoat`,C=`struct clearcoatOutParams
...
return outParams;}
#endif
`;t.IncludesShadersStore[S]||(t.IncludesShadersStore[S]=C);var nt={name:S,shader:C},w=`pbrBlockIridescence`,T=`struct iridescenceOutParams
...
#endif
`;t.IncludesShadersStore[w]||(t.IncludesShadersStore[w]=T);var E={name:w,shader:T},D=`pbrBlockSubSurface`,O=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;t.IncludesShadersStore[D]||(t.IncludesShadersStore[D]=O);var rt={name:D,shader:O},k=`pbrBlockReflectance0`,A=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;t.IncludesShadersStore[k]||(t.IncludesShadersStore[k]=A);var it={name:k,shader:A},j=`pbrClusteredLightingFunctions`,M=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;t.IncludesShadersStore[j]||(t.IncludesShadersStore[j]=M);var at={name:j,shader:M},N=`pbrBlockNormalFinal`,P=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;t.IncludesShadersStore[N]||(t.IncludesShadersStore[N]=P);var ot={name:N,shader:P},F=`pbrBlockLightmapInit`,I=`#ifdef LIGHTMAP
...
#endif
`;t.IncludesShadersStore[F]||(t.IncludesShadersStore[F]=I);var st={name:F,shader:I},L=`pbrBlockGeometryInfo`,R=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;t.IncludesShadersStore[L]||(t.IncludesShadersStore[L]=R);var ct={name:L,shader:R},z=`pbrBlockReflectance`,B=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;t.IncludesShadersStore[z]||(t.IncludesShadersStore[z]=B);var lt={name:z,shader:B},V=`pbrBlockDirectLighting`,H=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;t.IncludesShadersStore[V]||(t.IncludesShadersStore[V]=H);var ut={name:V,shader:H},U=`pbrBlockFinalLitComponents`,W=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;t.IncludesShadersStore[U]||(t.IncludesShadersStore[U]=W);var dt={name:U,shader:W},G=`pbrBlockFinalUnlitComponents`,K=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;t.IncludesShadersStore[G]||(t.IncludesShadersStore[G]=K);var ft={name:G,shader:K},q=`pbrBlockFinalColorComposition`,J=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;t.IncludesShadersStore[q]||(t.IncludesShadersStore[q]=J);var pt={name:q,shader:J},Y=`pbrBlockPrePass`,X=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;t.IncludesShadersStore[Y]||(t.IncludesShadersStore[Y]=X);var mt={name:Y,shader:X},ht=e({pbrPixelShader:()=>$}),Z=`pbrPixelShader`,Q=`#define PBR_FRAGMENT_SHADER
...
`;t.ShadersStore[Z]||(t.ShadersStore[Z]=Q);var gt=[Se,Ce,Te,Ke,xe,Oe,Ge,ke,ze,me,he,te,qe,je,Je,de,ae,ve,oe,Ee,ue,Le,Pe,Ue,fe,be,le,ge,Ve,Ie,Ne,Fe,Re,Me,re,ne,ye,Ae,Ye,Xe,Ze,Qe,$e,et,tt,nt,E,rt,_e,it,at,ie,He,ee,ot,we,st,ct,lt,ut,pe,dt,ft,pt,se,ce,Be,mt,De,We];for(let e of gt)t.IncludesShadersStore[e.name]||(t.IncludesShadersStore[e.name]=e.shader);var $={name:Z,shader:Q};export{ht as n,$ as t};