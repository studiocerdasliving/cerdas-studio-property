import{t as e}from"./rolldown-runtime-WNZMJCWm.js";import{t}from"./shaderStore-Cl2MRAbk.js";var n=e({iblShadowSpatialBlurPixelShaderWGSL:()=>a}),r=`iblShadowSpatialBlurPixelShader`,i=`#define PI 3.1415927
...
fragmentOutputs.color= vec4f(X.x/X.w,X.y/X.w,X.z/X.w,1.0);}`;t.ShadersStoreWGSL[r]||(t.ShadersStoreWGSL[r]=i);var a={name:r,shader:i};export{n,a as t};