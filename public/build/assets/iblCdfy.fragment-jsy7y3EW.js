import{t as e}from"./rolldown-runtime-WNZMJCWm.js";import{t}from"./shaderStore-Cl2MRAbk.js";import{t as n}from"./helperFunctions-XZzpehR-.js";var r=e({iblCdfyPixelShader:()=>s}),i=`iblCdfyPixelShader`,a=`precision highp sampler2D;precision highp samplerCube;
...
gl_FragColor=vec4(cdfy,0.0,0.0,1.0);}`;t.ShadersStore[i]||(t.ShadersStore[i]=a);var o=[n];for(let e of o)t.IncludesShadersStore[e.name]||(t.IncludesShadersStore[e.name]=e.shader);var s={name:i,shader:a};export{r as n,s as t};