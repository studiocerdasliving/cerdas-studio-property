import{t as e}from"./rolldown-runtime-WNZMJCWm.js";import{t}from"./shaderStore-Cl2MRAbk.js";var n=e({iblShadowSpatialBlurPixelShader:()=>a}),r=`iblShadowSpatialBlurPixelShader`,i=`precision highp sampler2D;
#define PI 3.1415927
...
gl_FragColor=vec4(X.x/X.w,X.y/X.w,X.z/X.w,1.0);}`;t.ShadersStore[r]||(t.ShadersStore[r]=i);var a={name:r,shader:i};export{n,a as t};