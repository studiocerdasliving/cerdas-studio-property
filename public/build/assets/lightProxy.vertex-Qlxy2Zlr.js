...
`;t.ShadersStoreWGSL[a]||(t.ShadersStoreWGSL[a]=o);var s=[r,n];for(let e of s)t.IncludesShadersStoreWGSL[e.name]||(t.IncludesShadersStoreWGSL[e.name]=e.shader);var c={name:a,shader:o};export{i as t};