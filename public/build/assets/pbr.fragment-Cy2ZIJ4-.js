import{t as e}from"./rolldown-runtime-WNZMJCWm.js";import{t}from"./shaderStore-Cl2MRAbk.js";import{t as ee}from"./bumpFragment-DFGVDgoe.js";import{t as n}from"./samplerFragmentDeclaration-CKcoTC7g.js";import{t as r}from"./bumpFragmentFunctions-Dy5j7nsT.js";import{t as te}from"./bumpFragmentMainFunctions-DwJekJDD.js";import{t as ne}from"./clipPlaneFragment-B5ejIpVP.js";import{t as re}from"./clipPlaneFragmentDeclaration-BxvG-V2U.js";import{t as ie}from"./fogFragmentDeclaration-Bc2fDDwH.js";import{t as ae}from"./logDepthFragment-C81THFK4.js";import{t as oe}from"./fogFragment-E2nd7wnn.js";import{t as se}from"./harmonicsFunctions-wL5E3BED.js";import{t as ce}from"./helperFunctions-Djh0sij1.js";import{t as le}from"./imageProcessingDeclaration-D9xTQOxH.js";import{t as ue}from"./imageProcessingFunctions-BzShnS-E.js";import{t as de}from"./lightFragment-DqaqA5Ep.js";import{t as fe}from"./lightUboDeclaration-Cte6c5rj.js";import{t as pe}from"./ltcHelperFunctions-EAX2-n3v.js";import{t as me}from"./clusteredLightingFunctions-CnbOVSo5.js";import{t as he}from"./logDepthDeclaration-D7WB_x2I.js";import{t as ge}from"./reflectionFunction-WTBpVMs8.js";import{t as _e}from"./shadowsFragmentFunctions-CDP9ih3X.js";import{t as ve}from"./sceneUboDeclaration-B6mDFmkL.js";import{t as ye}from"./meshUboDeclaration-ooIKMxUe.js";import{a as be,i as xe,n as Se,r as Ce,t as i}from"./oitFragment-BFLLO9Kf.js";import{t as a}from"./mainUVVaryingDeclaration-VCNLG_TF.js";import{t as we}from"./decalFragment-BlMn03v4.js";import{n as Te,t as Ee}from"./pbrIBLFunctions-BYdvNQ2G.js";import{t as De}from"./pbrBRDFFunctions-C-wkVMnm.js";import{n as Oe,t as ke}from"./hdrFilteringFunctions-DjZDY-fd.js";import{a as Ae,c as je,i as Me,l as Ne,n as Pe,o as Fe,r as Ie,s as Le,t as Re,u as ze}from"./pbrDebug-BrYMm-Tv.js";import{t as Be}from"./pbrUboDeclaration-CgF0DD96.js";var o=`samplerFragmentAlternateDeclaration`,s=`#ifdef _DEFINENAME_
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[o]||(t.IncludesShadersStoreWGSL[o]=s);var c={name:o,shader:s},l=`pbrFragmentSamplersDeclaration`,u=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;t.IncludesShadersStoreWGSL[l]||(t.IncludesShadersStoreWGSL[l]=u);var d={name:l,shader:u},f=`pbrBlockAlbedoOpacity`,p=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;t.IncludesShadersStoreWGSL[f]||(t.IncludesShadersStoreWGSL[f]=p);var Ve={name:f,shader:p},m=`pbrBlockReflectivity`,h=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;t.IncludesShadersStoreWGSL[m]||(t.IncludesShadersStoreWGSL[m]=h);var He={name:m,shader:h},g=`pbrBlockAmbientOcclusion`,_=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;t.IncludesShadersStoreWGSL[g]||(t.IncludesShadersStoreWGSL[g]=_);var Ue={name:g,shader:_},v=`pbrBlockAlphaFresnel`,y=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[v]||(t.IncludesShadersStoreWGSL[v]=y);var We={name:v,shader:y},b=`pbrBlockAnisotropic`,x=`#ifdef ANISOTROPIC
...
#endif
`;t.IncludesShadersStoreWGSL[b]||(t.IncludesShadersStoreWGSL[b]=x);var Ge={name:b,shader:x},S=`pbrBlockReflection`,C=`#ifdef REFLECTION
...
#endif
`;t.IncludesShadersStoreWGSL[S]||(t.IncludesShadersStoreWGSL[S]=C);var Ke={name:S,shader:C},w=`pbrBlockSheen`,T=`#ifdef SHEEN
...
#endif
`;t.IncludesShadersStoreWGSL[w]||(t.IncludesShadersStoreWGSL[w]=T);var qe={name:w,shader:T},E=`pbrBlockClearcoat`,D=`struct clearcoatOutParams
...
return outParams;}
#endif
`;t.IncludesShadersStoreWGSL[E]||(t.IncludesShadersStoreWGSL[E]=D);var O={name:E,shader:D},k=`pbrBlockIridescence`,A=`struct iridescenceOutParams
...
#endif
`;t.IncludesShadersStoreWGSL[k]||(t.IncludesShadersStoreWGSL[k]=A);var Je={name:k,shader:A},j=`pbrBlockSubSurface`,M=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;t.IncludesShadersStoreWGSL[j]||(t.IncludesShadersStoreWGSL[j]=M);var Ye={name:j,shader:M},N=`pbrBlockNormalFinal`,P=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[N]||(t.IncludesShadersStoreWGSL[N]=P);var Xe={name:N,shader:P},F=`pbrBlockLightmapInit`,I=`#ifdef LIGHTMAP
...
#endif
`;t.IncludesShadersStoreWGSL[F]||(t.IncludesShadersStoreWGSL[F]=I);var Ze={name:F,shader:I},L=`pbrBlockGeometryInfo`,R=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[L]||(t.IncludesShadersStoreWGSL[L]=R);var Qe={name:L,shader:R},z=`pbrBlockReflectance`,B=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[z]||(t.IncludesShadersStoreWGSL[z]=B);var $e={name:z,shader:B},V=`pbrBlockDirectLighting`,H=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;t.IncludesShadersStoreWGSL[V]||(t.IncludesShadersStoreWGSL[V]=H);var et={name:V,shader:H},U=`pbrBlockFinalLitComponents`,W=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[U]||(t.IncludesShadersStoreWGSL[U]=W);var tt={name:U,shader:W},G=`pbrBlockFinalUnlitComponents`,K=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;t.IncludesShadersStoreWGSL[G]||(t.IncludesShadersStoreWGSL[G]=K);var nt={name:G,shader:K},q=`pbrBlockFinalColorComposition`,J=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;t.IncludesShadersStoreWGSL[q]||(t.IncludesShadersStoreWGSL[q]=J);var rt={name:q,shader:J},Y=`pbrBlockPrePass`,X=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[Y]||(t.IncludesShadersStoreWGSL[Y]=X);var it={name:Y,shader:X},at=e({pbrPixelShaderWGSL:()=>$}),Z=`pbrPixelShader`,Q=`#define PBR_FRAGMENT_SHADER
...
`;t.ShadersStoreWGSL[Z]||(t.ShadersStoreWGSL[Z]=Q);var ot=[be,xe,ve,ye,Be,a,ze,fe,n,c,Te,d,le,re,he,ie,Ce,ce,Ne,Oe,je,ue,_e,se,pe,Le,Fe,De,ke,me,Ae,Me,Ee,te,r,ge,we,Ve,He,Ue,We,Ge,Ke,qe,O,Je,Ye,ne,Ie,ee,Xe,Se,Ze,Qe,$e,et,de,tt,nt,rt,ae,oe,Pe,it,i,Re];for(let e of ot)t.IncludesShadersStoreWGSL[e.name]||(t.IncludesShadersStoreWGSL[e.name]=e.shader);var $={name:Z,shader:Q};export{at as n,$ as t};